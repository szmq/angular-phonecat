describe('PhoneCat Application', function() {
  ...
  describe('View: Phone list', function() {
    ...
    it('should filter the phone list as a user types' +
    ...
    it('should be possible to control phone order' +
       'via the drop-down menu', function() {
  ...
  describe('View: Phone detail', function() {
    ...
    it('should display the first phone image' +
       'as the main phone image', function() {
    ...
    it('should swap the main image when' +
       'clicking on a thumbnail image', function() {
      var mainImage = element(by.css('img.phone.selected'));
